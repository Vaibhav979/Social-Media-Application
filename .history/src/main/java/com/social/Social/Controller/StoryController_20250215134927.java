...
public class StoryController {
    ...
    public Stories createStroy(@RequestBody Stories story) {
        Stories newStory = new Stories("1", "0");// This is a new object, it does not reference the object passed in the
                                                 // request body
    ...
    public Stories updateStory(@RequestBody Stories story) {
        Stories story1 = new Stories("1", "0");
        if(story.getSetStory()!=null){
            story1.setSetStory(story.getSetStory());
        }if(story.getRemoveStory()!=null){
            story1.setRemoveStory(story.getRemoveStory());
        }
    }
